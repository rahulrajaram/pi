...
By default, pi gives the model these built-in tools:
...
Extension and custom tools are also enabled by default as they load. Pi runs in your current working directory and can modify files there. Use git or another checkpointing workflow if you want easy rollback.
